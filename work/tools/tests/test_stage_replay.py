...
def replay_source(tmp_path: Path) -> dict[str, Path | str]:
    ...
    _write_jsonl(state / "scout_receipts.jsonl", [{
        ...
        "candidate_count": 1,
        "candidate_ids": ["OBS-2"],
        "coverage_report_sha256": "b" * 64,
        "assigned_section_ids": [],
        "reviewed_section_ids": [],
        "assigned_anchor_paths": ["audit.py"],
        "reviewed_anchor_paths": ["audit.py"],
    }, {
        "session_id": session_id,
        "sweep_id": "RISK-SWEEP-CONTRACT",
        "direction": "design_to_code",
        ...
        "assigned_section_ids": ["contract-main"],
        "reviewed_section_ids": ["contract-main"],
